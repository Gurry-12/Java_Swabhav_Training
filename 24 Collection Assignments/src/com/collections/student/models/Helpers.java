...
public class Helpers {
	...
	public static String validateStudentId(Scanner scanner) {
	    final Pattern STUDENT_ID_PATTERN = Pattern.compile("^(UG|PG)\\d{4,}$");

	    while (true) {
	        System.out.print("Enter Student ID (UG1000 or PG5000 format): ");
	        String input = scanner.nextLine().trim().toUpperCase();
	        ...
	        System.out.println("Invalid format. Use UG/PG prefix followed by digits (e.g. UG1000, PG5000).");
	    }
	}
