package com.collections.inventory.utility;
...
public class Helpers {
	...
	public static String validateProductId(Scanner scanner) {
	    final Pattern PRODUCT_ID_PATTERN = Pattern.compile("^(EP|GR)\\d{4,}$");

	    while (true) {
	        System.out.print("Enter Product ID (EP1000 or GR5000 format): ");
	        String input = scanner.nextLine().trim().toUpperCase();
	        ...
	        System.out.println("Invalid format. Use EP/GR prefix followed by digits (e.g. EP1000, GR5000).");
	    }
	}
