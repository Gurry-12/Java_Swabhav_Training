package com.collections.course.utility;
...
public class Helpers {
	...
	public static String validateParticipantId(Scanner scanner) {
	    final Pattern PARTICIPANT_ID_PATTERN = Pattern.compile("^(RP|CP)\\d{4,}$");

	    while (true) {
	        System.out.print("Enter Participant ID (RP1000 or CP5000 format): ");
	        String input = scanner.nextLine().trim().toUpperCase();
	        ...
	        if (PARTICIPANT_ID_PATTERN.matcher(input).matches()) {
	            return input;
	        }

	        System.out.println("Invalid format. Use RP/CP prefix followed by digits (e.g. RP1000, CP5000).");
	    }
	}
