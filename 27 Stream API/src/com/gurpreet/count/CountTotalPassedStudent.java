...
public class CountTotalPassedStudent {
	public static void main(String[] args) {
		...
		long countOfPassedStudents = students.stream().filter(student -> student.getMarks() >= 40).count();
		
		System.out.println("Total count of passed student : " + countOfPassedStudents);
	}
}
